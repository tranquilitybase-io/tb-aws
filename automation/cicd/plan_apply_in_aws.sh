...
terraform state rm module.aws_lz_cloudtrail.sns_topic_default.sns_topic_default
#terraform state rm module.aws_lz_cloudtrail.aws_cloudtrail.cloudtrail_default
